...
font = pygame.font.Font('assets/AbhayaLibre-Regular.ttf', 48)
medium_font = pygame.font.Font('assets/AbhayaLibre-Regular.ttf', 28)
small_font = pygame.font.Font('assets/AbhayaLibre-Regular.ttf', 16)
real_small_font = pygame.font.Font('assets/AbhayaLibre-Regular.ttf', 10)
fps = 60
...
def draw_title_bar():
    instruction_text = medium_font.render('Fel/Le nyilakkal halad a bal kéz', True, 'black')
    screen.blit(instruction_text, (WIDTH - 500, 10))
    instruction_text2 = medium_font.render('Bal/Jobb nyilakkal halad a jobb kéz', True, 'black')
    screen.blit(instruction_text2, (WIDTH - 500, 50))
    title_text = font.render('Python zongora!', True, 'white')
    screen.blit(title_text, (250, 18))
    title_text = font.render('Python zongora!', True, 'black')
    screen.blit(title_text, (252, 20))
